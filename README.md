...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5514.109  6151.174  6892.837  7656.683  8270.439  8980.197  9802.352
#>  [8] 10675.686 11534.772 12398.902 13010.335 13682.912 14508.510 15348.325
#> [15] 16099.516 16826.013 17550.872 18187.905 18783.528 19441.854
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5551.806  6233.702  6880.585  7549.614  8296.695  9071.170  9783.811
#>  [8] 10478.499 11150.900 11884.865 12655.595 13395.364 14128.613 14857.541
#> [15] 15536.866 16303.143 17028.356 17849.651 18592.378 19419.186
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 4176.6976 4635.2667 4466.2825 2933.1397 2156.8178 1417.7492 1261.2075
#>  [8] 1436.9867 1734.9561 1594.3612 1470.7392 1540.6786 1171.4127  978.2833
#> [15]  306.2402  590.6427  249.9748 -150.5824  635.3195 1578.3419
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 4616.389 3768.520 4179.491 3604.620 3459.099 3029.937 3178.065
#>  [8] 5478.187 6156.506 5757.658 5394.275 5300.549 5278.558 5658.804
#> [15] 5465.923 6570.370 5976.033 5572.444 5862.981 5648.551
```
...
#>   entropy lumpiness stability hurst trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl> <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.769         0         0 0.973 0.999  3.80e- 9      3.60    0.0575
#> 2   0.768         0         0 0.973 1.000  7.53e-11      3.60    0.0369
#> 3   0.824         0         0 0.960 0.894  1.47e- 4     -2.97    1.11  
#> 4   0.872         0         0 0.912 0.690  1.03e- 3      1.99    0.499 
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.5372963
#> [2,] 1.698388 0.9229687 1.698388 0.6123443 1.096000 0.2797897
#> 
#> $ARIMA
...
# Forecast combination based on FFORMS

``` r
# extract only the values for two time series just for illustration
votes.matrix <- rf$randomforest$votes[1:2,]
...
#> [[1]]$mean
#>          [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 565367.8 598790.3 632212.7 665635.2 699057.7 732480.2
#> 
#> [[1]]$lower
#>          [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 504011.6 523634.6 542850.8 560545.9 576545.2 590977.2
#> 
#> [[1]]$upper
#>        [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 626724 673945.9 721574.7 770724.6 821570.2 873983.2
#> 
#> 
#> [[2]]
#> [[2]]$mean
#>          [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 393252.1 402461.7 411671.4 420881.1 430090.7 439300.4
#> 
#> [[2]]$lower
#>          [,1]     [,2]     [,3]     [,4]   [,5]     [,6]
#> [1,] 339758.2 318613.6 298767.3 278562.5 257459 235218.8
#> 
#> [[2]]$upper
#>          [,1]     [,2]     [,3]     [,4]     [,5]   [,6]
#> [1,] 446745.9 486309.9 524575.5 563199.6 602722.5 643382
```
