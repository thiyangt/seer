...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5313.459  5849.940  6335.558  6943.654  7598.612  8258.462  8897.920
#>  [8]  9703.727 10425.304 11184.947 11914.149 12768.654 13702.352 14616.840
#> [15] 15497.054 16224.001 16862.773 17392.518 17826.213 18323.732
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5469.347  5978.989  6531.626  7077.785  7517.380  8000.849  8373.809
#>  [8]  8910.166  9527.318 10190.755 10921.521 11568.926 12045.517 12488.609
#> [15] 12876.553 13410.161 14065.442 14636.600 15209.564 15694.232
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 5014.936 5105.543 5102.616 6421.575 6052.581 4813.606 4993.471
#>  [8] 5049.547 6232.423 6435.281 6669.897 6620.241 7724.042 7449.998
#> [15] 7674.112 7166.552 6074.536 5268.235 4004.218 3259.989
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 3212.980 3296.324 3196.062 3245.387 2643.353 2088.304 2401.575
#>  [8] 3100.068 3953.145 4699.401 3740.921 4473.116 5767.836 4895.956
#> [15] 5244.733 5515.097 5311.941 5738.504 6403.201 6651.519
```
...
#>   entropy lumpiness stability hurst trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl> <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.768         0         0 0.973 1.000   1.02e-9      3.59     0.239
#> 2   0.769         0         0 0.973 0.999   1.48e-8      3.60     0.149
#> 3   0.923         0         0 0.919 0.743   6.74e-4      2.85     1.12 
#> 4   0.894         0         0 0.928 0.784   3.63e-4      2.44     1.49 
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.4636606
#> [2,] 1.698388 0.9229687 1.698388 0.6123443 1.096000 0.2796962
#> 
#> $ARIMA
