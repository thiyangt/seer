...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5493.265  6083.578  6827.756  7590.616  8453.429  9493.872 10530.002
#>  [8] 11550.902 12514.572 13495.256 14418.061 15332.953 16416.050 17621.606
#> [15] 19009.489 20461.889 21887.147 23290.131 24650.431 25932.793
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5550.266  6039.679  6540.345  6804.731  7178.111  7439.518  7877.330
#>  [8]  8193.390  8577.787  9039.239  9467.124  9785.218  9976.283 10183.808
#> [15] 10395.826 10752.703 11176.151 11551.509 11955.900 12284.080
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 4588.594 4409.671 3807.543 3720.681 2693.955 2209.017 2304.167
#>  [8] 1762.075 1811.102 2238.960 2608.165 2591.068 2394.168 3407.279
#> [15] 2254.790 2778.696 3814.313 3832.610 4240.825 4447.400
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 4716.807 5578.635 6313.855 6061.853 6435.618 6396.025 6136.984
#>  [8] 6365.745 6702.916 5701.624 4978.624 4220.064 3251.277 3675.578
#> [15] 5816.965 6355.045 6635.502 6278.457 6390.363 7043.409
```
...
#>   entropy lumpiness stability hurst trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl> <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.769         0         0 0.973 0.999   3.74e-9      3.58    0.133 
#> 2   0.768         0         0 0.973 0.997   4.18e-8      3.58   -0.0975
#> 3   0.846         0         0 0.946 0.899   7.50e-5     -2.20    2.04  
#> 4   0.864         0         0 0.945 0.875   2.27e-4     -1.79   -2.18  
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.5050125
#> [2,] 1.698388 0.9229687 1.698388 0.6123443 1.096000 0.2796566
#> 
#> $ARIMA
