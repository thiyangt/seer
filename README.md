...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5575.976  6173.275  6847.313  7558.904  8361.425  9213.497 10142.832
#>  [8] 11010.869 11895.075 12735.820 13513.413 14317.685 15259.166 16178.948
#> [15] 17178.502 18198.558 19311.666 20222.048 21009.618 21752.211
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5619.230  6174.481  6614.829  7110.996  7689.133  8309.723  9098.783
#>  [8]  9845.569 10552.984 11167.300 11758.966 12318.064 12857.271 13412.144
#> [15] 14081.375 14655.171 15213.818 15724.162 16389.321 17230.632
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 4167.451 4051.005 3706.418 4097.802 3196.399 3227.541 3903.135
#>  [8] 4068.359 3409.780 2878.932 2980.347 2344.465 2435.285 1586.629
#> [15] 3578.388 4881.409 5696.991 4924.813 4979.228 3638.543
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 4627.482 5558.363 6077.713 5715.532 5745.253 6621.694 5948.083
#>  [8] 4865.915 4593.489 4639.391 4364.078 3509.530 4099.621 4148.513
#> [15] 5196.147 4419.947 4162.825 3453.922 2496.820 2980.550
```
...
#>   entropy lumpiness stability hurst trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl> <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.769         0         0 0.973 1.000  6.96e-10      3.59    0.0934
#> 2   0.768         0         0 0.974 0.999  5.73e- 9      3.56    0.0361
#> 3   0.873         0         0 0.931 0.841  2.04e- 4     -3.15   -0.781 
#> 4   0.875         0         0 0.925 0.739  8.46e- 4     -2.12   -1.05  
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.5444208
#> [2,] 1.698388 0.9229687 1.698388 0.6123443 1.096000 0.2799555
#> 
#> $ARIMA
