...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5575.436  6353.583  7051.650  7775.339  8526.988  9149.763  9848.348
#>  [8] 10389.995 10725.117 11103.579 11617.429 12255.423 13029.609 13702.902
#> [15] 14354.789 14957.349 15542.684 16124.728 16781.214 17593.114
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5474.574  6105.076  6708.345  7228.495  7839.765  8491.706  9172.651
#>  [8]  9826.776 10485.311 11098.721 11677.464 12267.950 12950.963 13646.536
#> [15] 14436.453 15283.959 16128.300 17074.829 17900.310 18850.406
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 5108.037 4233.631 5491.645 4751.684 5069.781 4331.262 4949.889
#>  [8] 4467.187 4326.517 4727.340 5406.631 4670.199 4441.761 5126.005
#> [15] 5934.829 6756.670 6131.272 6244.977 7190.989 6201.918
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 4956.324 4479.015 6075.445 5695.337 6239.064 7119.371 8642.461
#>  [8] 9296.127 9439.964 8173.281 7825.775 8874.516 8188.268 7861.767
#> [15] 7230.722 6169.322 7167.599 7016.524 8155.417 9357.671
```
...
#>   entropy lumpiness stability hurst  trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl>  <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.770         0         0 0.972 0.998   3.75e- 8     3.63    -0.164 
#> 2   0.768         0         0 0.973 1.000   2.16e-10     3.60     0.0317
#> 3   0.976         0         0 0.500 0.0629  6.67e- 3    -0.252    0.715 
#> 4   0.852         0         0 0.950 0.869   7.08e- 5     2.71    -1.39  
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.5937151
#> [2,] 1.698388 0.9229687 1.698388 0.6123443 1.096000 0.2796045
#> 
#> $ARIMA
