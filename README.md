...
#> End = 2008 
#> Frequency = 1 
#>  [1]  5605.620  6259.356  6824.944  7409.307  7945.627  8501.029  9172.383
#>  [8]  9819.951 10604.716 11351.020 12116.477 12901.636 13838.405 14887.140
#> [15] 15944.204 16874.406 17713.441 18621.136 19508.409 20396.601
#> 
#> $N0001[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1]  5618.251  6249.573  6820.072  7478.477  8111.634  8802.143  9548.677
#>  [8] 10217.932 10831.829 11545.662 12237.915 12850.050 13450.127 14068.606
#> [15] 14700.917 15233.428 15759.792 16400.746 17042.628 17705.787
#> 
#> 
#> $N0002
#> $N0002[[1]]
...
#> End = 2008 
#> Frequency = 1 
#>  [1] 4186.3085 4474.8124 3888.3909 3743.8079 3048.0573 1865.8811 1961.1770
#>  [8] 1712.6377  974.9551 1195.1707 1478.9457 1623.1942 1591.1904 1593.8230
#> [15] 1526.7923 1219.5705 2700.6949 2738.7889 3071.7064 2585.1726
#> 
#> $N0002[[2]]
#> Time Series:
#> Start = 1989 
#> End = 2008 
#> Frequency = 1 
#>  [1] 5150.608 4501.331 4569.920 3816.465 3418.934 3971.333 3700.645
#>  [8] 3643.127 4411.289 4801.574 3704.102 3441.743 3055.594 3407.990
#> [15] 2703.810 2243.502 2922.343 3029.387 2241.141 1656.602
```
...
#>   entropy lumpiness stability hurst trend spikiness linearity curvature
#> *   <dbl>     <dbl>     <dbl> <dbl> <dbl>     <dbl>     <dbl>     <dbl>
#> 1   0.768         0         0 0.972 0.999  4.79e- 9      3.61  0.263   
#> 2   0.768         0         0 0.973 1.000  1.54e-10      3.59 -0.000485
#> 3   0.829         0         0 0.965 0.942  2.98e- 5     -3.00  1.27    
#> 4   0.949         0         0 0.839 0.623  2.56e- 3     -2.34  0.625   
#> # … with 17 more variables: e_acf1 <dbl>, y_acf1 <dbl>, diff1y_acf1 <dbl>,
#> #   diff2y_acf1 <dbl>, y_pacf5 <dbl>, diff1y_pacf5 <dbl>,
#> #   diff2y_pacf5 <dbl>, nonlinearity <dbl>, lmres_acf1 <dbl>, ur_pp <dbl>,
#> #   ur_kpss <dbl>, N <int>, y_acf5 <dbl>, diff1y_acf5 <dbl>,
...
#> [1,] 1.566974 1.5636089 7.703518 4.2035176 6.017236 2.5548643
...
#> [[1]]$mean
#>          [,1]     [,2]     [,3]   [,4]     [,5]     [,6]
#> [1,] 572590.9 602333.2 632075.6 661818 691560.3 721302.7
#> 
#> [[1]]$lower
#>        [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 510671 518481.5 528353.9 538509.1 548417.7 557931.1
#> 
#> [[1]]$upper
#>          [,1]   [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 634510.7 686185 735797.3 785126.8 834702.9 884674.3
#> 
#> 
#> [[2]]
#> [[2]]$mean
#>          [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 393741.6 403440.9 413140.3 422839.6 432538.9 442238.3
#> 
#> [[2]]$lower
#>          [,1]     [,2]     [,3]     [,4]     [,5]   [,6]
#> [1,] 340836.4 320778.3 302139.8 283259.1 263590.5 242892
#> 
#> [[2]]$upper
#>          [,1]     [,2]     [,3]     [,4]     [,5]     [,6]
#> [1,] 446646.8 486103.5 524140.8 562420.1 601487.4 641584.5
```
