...
#' @param testset features of new time series, default NA if a testset is not available
...
#' @export
build_rf <- function(training_set, testset=NA, rf_type=c("ru", "rcp"), ntree, seed, import=FALSE, mtry=8){
